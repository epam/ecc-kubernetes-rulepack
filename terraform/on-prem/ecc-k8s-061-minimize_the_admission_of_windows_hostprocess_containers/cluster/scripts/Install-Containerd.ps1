...
Start-Transcript -Path c:\installContainerD-logs.log -Append
...
Start-Process -Wait -NoNewWindow -FilePath cmd  -ArgumentList '/c', 'tar', '-xf', "`"C:\Program Files\containerd\containerd.tar.gz`"", '--strip=1', '-C', "`"$global:ContainerDPath`""
