...
Start-Transcript -Path c:\prepareNode-logs.log -Append
whoami
...
#Start-Process -Wait -NoNewWindow -FilePath cmd  -ArgumentList '/c', 'tar', 'C', "`"$global:NssmInstallDirectory`"",  '-xvf', 'C:\Users\Administrator\nssm.zip', '--strip-components=2', "`"*/$arch/*.exe`""
